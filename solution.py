...
# Classifier
from sklearn.naive_bayes import MultinomialNB #CHANGE1: Text classification doesn't follow normal distribution
...
params = {
    'alpha': np.logspace(-3, 1, 5)  # CHANGE2: Couldn't use var_smoothing as it is Gaussian specific
}
...
for repeated_time in range(REPEAT):
    ...
    indices, test_size=0.2, random_state=42  #CHANGE4: Allows for same split of training and test sets (for comparison)
)
    ...
    ngram_range=(1, 2),  #CHANGE3: Pairs of words captures more context
    max_features=5000    
)
